...
namespace TestEngine.Services
{
    ...
    public class TestSaveGameService
    {
        ...
        public void Test_Restore_0_1_000()
        {
            ...
            Assert.AreEqual("Calle", gameSession.CurrentPlayer.Name);
            Assert.AreEqual(18, gameSession.CurrentPlayer.Dexterity);
            Assert.AreEqual(2, gameSession.CurrentPlayer.CurrentHitPoints);
            ...
            Assert.AreEqual(1003, gameSession.CurrentPlayer.Gold);
